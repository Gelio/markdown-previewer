...
/***/ function(module, exports, __webpack_require__) {
	...
	var _MarkdownArea = __webpack_require__(167);

	var _MarkdownArea2 = _interopRequireDefault(_MarkdownArea);

	var _MarkdownDisplay = __webpack_require__(168);
	...
	var Layout = function (_React$Component) {
	    ...
	    function Layout() {
	        ...
	        _this.state = {
	            markdownText: __webpack_require__(170)
	        };
	        return _this;
	    }

	    _createClass(Layout, [{
	        key: 'changeMarkdownText',
	        value: function changeMarkdownText(text) {
	            this.setState({
	                markdownText: text
	            });
	        }
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'div',
	                    { className: 'col-md-6' },
	                    _react2.default.createElement(_MarkdownArea2.default, { markdownText: this.state.markdownText, changeMarkdownText: this.changeMarkdownText.bind(this) })
	                ),
	                _react2.default.createElement(
	                    'div',
	                    { className: 'col-md-6' },
	                    _react2.default.createElement(_MarkdownDisplay2.default, { markdownText: this.state.markdownText })
	                )
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MarkdownArea = function (_React$Component) {
	    _inherits(MarkdownArea, _React$Component);

	    function MarkdownArea() {
	        _classCallCheck(this, MarkdownArea);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(MarkdownArea).apply(this, arguments));
	    }

	    _createClass(MarkdownArea, [{
	        key: "handleInput",
	        ...
	        key: "render",
	        value: function render() {
	            return _react2.default.createElement("textarea", { className: "markdown-input", defaultValue: this.props.markdownText, onChange: this.handleInput.bind(this) });
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _marked = __webpack_require__(169);
	...
	var MarkdownDisplay = function (_React$Component) {
	    ...
	    function MarkdownDisplay() {
	        ...
	        return _possibleConstructorReturn(this, Object.getPrototypeOf(MarkdownDisplay).apply(this, arguments));
	    }

	    _createClass(MarkdownDisplay, [{
	        key: 'render',
	        value: function render() {
	            return _react2.default.createElement('div', { dangerouslySetInnerHTML: { __html: (0, _marked2.default)(this.props.markdownText) }, className: 'markdown-preview' });
	        }
	    }]);
